...
python runner.py --seed 1234 --id x1  --save_epoch 10 --num_epoch 80  --diagonal_positional_attention --batch_size 100
python runner.py --seed 1234 --id x2  --save_epoch 10 --num_epoch 80  --diagonal_positional_attention
python runner.py --seed 1234 --id x3  --save_epoch 10 --num_epoch 80  --diagonal_positional_attention --num_layers_encoder 2 --n_head 6
