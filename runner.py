...
parser.add_argument('--temper_value', type=float, default=0.5,
                    help='Temper value for Scaled Attention.')  # 0.5 original
...
parser.add_argument(
    '--id', type=str,
    default='tmp_model',  # change model folder output before running
...
# TODO: this setting doesn't seem to do anything in terms of performance. Investigate!
...
def main():
    ...
    for epoch in range(1, opt['num_epoch'] + 1):
        ...
        print(
            ...
            " weight_rest-" + str(opt["weight_rest"]) + " attn-" + str(opt["attn"]) + " attn_dim-" + str(
                opt["attn_dim"]),
