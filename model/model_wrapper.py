...
class PositionAwareAttention(nn.Module):
    ...
    def init_weights(self):
        ...
        # use zero to give uniform attention at the beginning
        self.tlinear.weight.data.zero_().to("cuda")
...
class PositionAwareRNN(nn.Module):
    ...
    def __init__(self, opt, emb_matrix=None):
        ...
        self.self_attention_encoder = Encoder(
            ...
            n_head=opt["n_head"],  # number of heads
    ...
    def init_weights(self):
        ...
        # decide on fine-tuning the word embeddings
        if self.topn <= 0:
    ...
    def forward(self, inputs):
        ...
        if self.opt['attn']:
            ...
            # either run pos. aware attention with self-attention or with LSTM (set as arg in runner.py)
            if self.opt["self_att_and_rnn"] is True:
